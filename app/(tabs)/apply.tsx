        ...
        {total === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyBody}>
              Add the schools you&rsquo;re applying to and track your progress here.
            </Text>
          </View>
        )}
      </ScrollView>
...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  ouacLabel: { fontSize: 11, color: c.muted, fontFamily: 'Inter_500Medium', textTransform: 'uppercase', letterSpacing: 1 },
  ...
  summaryCaption: { fontSize: 11, letterSpacing: 1.2, textTransform: 'uppercase', color: c.muted, fontFamily: 'Inter_500Medium' },
