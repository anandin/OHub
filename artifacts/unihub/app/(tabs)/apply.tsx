  ...
  return (
    <View style={styles.modalOverlay}>
      <View style={styles.modal}>
        ...
        <View style={styles.uniQuickGrid}>
          {UNI_QUICK.map(u => (
            <Pressable
              key={u.id}
              style={[styles.uniQuickChip, selectedUniId === u.id && styles.uniQuickChipActive]}
              onPress={() => setSelectedUniId(u.id)}
            >
              <Text style={[styles.uniQuickText, selectedUniId === u.id && styles.uniQuickTextActive]}>
                {u.label}
              </Text>
            </Pressable>
          ))}
        ...
        <Text style={styles.modalLabel}>Program name (optional)</Text>
        <TextInput
        ...
        <Pressable
          ...
          onPress={() => {
            if (selectedUniId) {
              onAdd(selectedUniId, programName);
              onClose();
            }
          }}
...
const styles = StyleSheet.create({
  ...
  uniQuickGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 16 },
  uniQuickChip: {
    paddingHorizontal: 12,
    paddingVertical: 7,
    borderRadius: 999,
  ...
  uniQuickChipActive: { backgroundColor: '#1a1612', borderColor: '#1a1612' },
  uniQuickText: { fontSize: 12, fontFamily: 'Inter_500Medium', color: '#1a1612' },
  uniQuickTextActive: { color: '#f5f1e8' },
  modalInput: {
